...
TEST_CASE("iterate_reversed_type_test")
{
    ...
    PL_TEST_STATIC_ASSERT(
        std::is_same<NonConstBeginIt, std::vector<int>::reverse_iterator>::value);
    PL_TEST_STATIC_ASSERT(
        std::is_same<NonConstEndIt, std::vector<int>::reverse_iterator>::value);

    PL_TEST_STATIC_ASSERT(
        std::is_same<ConstBeginIt, std::vector<int>::const_reverse_iterator>::value);
    PL_TEST_STATIC_ASSERT(
        std::is_same<ConstEndIt, std::vector<int>::const_reverse_iterator>::value);

    PL_TEST_STATIC_ASSERT(
        std::is_same<std::iterator_traits<NonConstBeginIt>::reference, int &>::value);
    PL_TEST_STATIC_ASSERT(
        std::is_same<std::iterator_traits<NonConstEndIt>::reference, int &>::value);

    PL_TEST_STATIC_ASSERT(
        std::is_same<std::iterator_traits<ConstBeginIt>::reference, const int &>::value);
    PL_TEST_STATIC_ASSERT(
        std::is_same<std::iterator_traits<ConstEndIt>::reference, const int &>::value);
