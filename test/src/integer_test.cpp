...
TEST_CASE("integer_test_byte_sizes")
{
  ...
  PL_TEST_STATIC_ASSERT(sizeof(pl::int_t<16>) == static_cast<std::size_t>(2U));
  PL_TEST_STATIC_ASSERT(sizeof(pl::int_t<32>) == static_cast<std::size_t>(4U));
  PL_TEST_STATIC_ASSERT(sizeof(pl::int_t<64>) == static_cast<std::size_t>(8U));
  PL_TEST_STATIC_ASSERT(sizeof(pl::uint_t<8>) == static_cast<std::size_t>(1U));
  PL_TEST_STATIC_ASSERT(sizeof(pl::uint_t<16>) == static_cast<std::size_t>(2U));
  PL_TEST_STATIC_ASSERT(sizeof(pl::uint_t<32>) == static_cast<std::size_t>(4U));
  PL_TEST_STATIC_ASSERT(sizeof(pl::uint_t<64>) == static_cast<std::size_t>(8U));
...
TEST_CASE("integer_test_min_max")
{
  ...
  PL_TEST_STATIC_ASSERT(
    std::numeric_limits<pl::uint_t<8>>::min PL_NO_MACRO_SUBSTITUTION() == 0U);
  PL_TEST_STATIC_ASSERT(
    std::numeric_limits<pl::uint_t<16>>::min PL_NO_MACRO_SUBSTITUTION() == 0U);
  PL_TEST_STATIC_ASSERT(
    std::numeric_limits<pl::uint_t<32>>::min PL_NO_MACRO_SUBSTITUTION() == 0U);
  PL_TEST_STATIC_ASSERT(
    std::numeric_limits<pl::uint_t<64>>::min PL_NO_MACRO_SUBSTITUTION() == 0U);
  PL_TEST_STATIC_ASSERT(
