...
{
  PL_TEST_STATIC_ASSERT(
    !std::is_same<pl::meta::type_identity_t<void>, int>::value);
  PL_TEST_STATIC_ASSERT(
    !std::is_same<pl::meta::type_identity_t<long double>, float>::value);
  PL_TEST_STATIC_ASSERT(
    !std::is_same<pl::meta::type_identity_t<std::string>, std::vector<char>>::
      value);
  PL_TEST_STATIC_ASSERT(
    !std::is_same<pl::meta::type_identity_t<unsigned long long>, short>::value);
